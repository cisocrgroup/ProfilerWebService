                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"base64Binary".equals(type)){
                                ...
                                return (Base64Binary)de.uni_muenchen.cis.www.profiler.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribContentType!=null){
                         java.lang.String content = tempAttribContentType;
                                                ...
                                                if (tempAttribContentType.indexOf(":") > 0) {
                                                    // this seems to be a Qname so find the namespace and send
                                                    prefix = tempAttribContentType.substring(0, tempAttribContentType.indexOf(":"));
                                                    namespaceuri = reader.getNamespaceURI(prefix);
                                                    object.setContentType(
                                                        org.w3.www._2005._05.xmlmime.ContentType_type0.Factory.fromString(tempAttribContentType,namespaceuri));
                                                } else {
                                                    // this seems to be not a qname send and empty namespace incase of it is
                                                    // check is done in fromString method
                                                    object.setContentType(
                                                        org.w3.www._2005._05.xmlmime.ContentType_type0.Factory.fromString(tempAttribContentType,""));
                                                }
